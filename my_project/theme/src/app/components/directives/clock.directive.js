(function() {
  ...
  /** @ngInject */
  function clock($interval, moment) {
    var directive = {
      restrict: 'EA',
      replace: true,
      scope: {
      ...
      link: function(scope, el) {
        var drawHands, getRad, getX, getY;
        ...
        drawHands = function() {
          var H_HAND_SIZE, M_HAND_SIZE, S_HAND_SIZE, drawHand, hour, r, strokeColor, t;
          S_HAND_SIZE = 0.95;
          M_HAND_SIZE = 0.85;
          H_HAND_SIZE = 0.55;
